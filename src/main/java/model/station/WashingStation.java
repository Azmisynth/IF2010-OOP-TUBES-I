...
public class WashingStation extends Station { 
    ...
    private void startOrContinueWashing(Chef chef) { // method buat mulai atau lanjutin proses cuci piring
